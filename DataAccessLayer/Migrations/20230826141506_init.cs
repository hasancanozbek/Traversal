    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationListId = table.Column<int>(type: "integer", nullable: false),
                    TripListId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationTrip", x => new { x.LocationListId, x.TripListId });
                    table.ForeignKey(
                        name: "FK_LocationTrip_Locations_LocationListId",
                        column: x => x.LocationListId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationTrip_Trips_TripListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationTrip_TripListId",
                table: "LocationTrip",
                column: "TripListId");
